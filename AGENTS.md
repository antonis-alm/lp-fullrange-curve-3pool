# LPFullRangeCurve3poolStrategy - Agent Guide

> AI coding agent context for the `l_p_full_range_curve_3pool` strategy.

## Overview

- **Template:** dynamic_lp
- **Chain:** ethereum
- **Class:** `LPFullRangeCurve3poolStrategy` in `strategy.py`
- **Config:** `config.json`
